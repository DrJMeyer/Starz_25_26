...
public class auto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        leftDrive  = hardwareMap.get(DcMotor.class, "fpd");
        rightDrive = hardwareMap.get(DcMotor.class, "fsd");
        leftBackDrive = hardwareMap.get(DcMotor.class, "bpd");
        rightBackDrive = hardwareMap.get(DcMotor.class, "bsd");
